...
export default {
  data() {
    return {
      categorys: ['5', '14a6b640-9299-41c4-b042-a6e078133aaa']
      // categorys: ['1', 'a228a8b2-02c7-402c-b112-e43577235db6', 'load40']
    };
  },
    ...
    computed: {
      categoryOptions() {
        return [{
          ...
          "title": "安全等级: 高级",
          /* "children": [{
            "guid": "a228a8b2-03577235db6",
            "categoryGuid": "a228c-b112-e43577235db6",
            "disabled": false,
            "label": "test2",
            "title": "安全等级: 中级"
          }] */
